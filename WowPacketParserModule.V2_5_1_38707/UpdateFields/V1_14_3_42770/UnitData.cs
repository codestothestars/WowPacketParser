...
namespace WowPacketParserModule.V2_5_1_38707.UpdateFields.V1_14_3_42770
{
    public class UnitData : IUnitData
    {
        ...
        public int[] ModPowerRegen  { get; } = new int[7];
        ...
        public ushort TrainingPointsUsed { get; set; }
        public ushort TrainingPointsTotal { get; set; }
        public int[] Stats { get; } = new int[5];
        public int[] StatPosBuff { get; } = new int[5];
        public int[] StatNegBuff { get; } = new int[5];
