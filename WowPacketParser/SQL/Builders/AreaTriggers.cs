...
namespace WowPacketParser.SQL.Builders
{
    ...
    public static class AreaTriggers
    {
        ...
        public static string AreaTriggerCreatePropertiesData()
        {
            ...
            if (!Settings.SqlTables.areatrigger_create_properties)
                return string.Empty;
        ...
        public static string AreaTriggerCreatePropertiesOrbitData()
        {
            ...
            if (!Settings.SQLOutputFlag.HasAnyFlagBit(Settings.SqlTables.areatrigger_create_properties_orbit))
                return string.Empty;
        ...
        public static string AreaTriggerCreatePropertiesSplinePointData()
        {
            ...
            if (!Settings.SqlTables.areatrigger_create_properties_spline_point)
                return string.Empty;
