...
namespace WowPacketParser.Store
{
    public static class Storage
    {
        ...
        public static readonly StoreDictionary<uint, CreatureTemplate> CreatureTemplates = new StoreDictionary<uint, CreatureTemplate>(Settings.SqlTables.creature_template_wdb );
