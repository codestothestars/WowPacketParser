...
namespace WowPacketParserModule.V6_0_2_19033.Parsers
{
    public static class MovementHandler
    {
        public static WowGuid ReadMovementStats(Packet packet, params object[] idx)
        {
            ...
            moveInfo.SplineElevation = packet.ReadSingle("StepUpStartElevation", idx);
            ...
            moveInfo.Flags = (uint)packet.ReadBitsE<MovementFlag>("Movement Flags", 30, idx);
            moveInfo.Flags2 = (uint)packet.ReadBitsE<MovementFlag2>("Extra Movement Flags", ClientVersion.AddedInVersion(ClientVersionBuild.V6_2_0_20173) ? 16 : 15, idx);
            ...
            if (hasTransport)
                ReadTransportData(moveInfo, packet, idx, "TransportData");

            if (hasFall)
                ReadFallData(moveInfo, packet, idx, "FallData");
        ...
        public static void HandleSplineSetFlightpeed(Packet packet)
        {
            WowGuid guid = packet.ReadPackedGuid128("Guid");
            CreatureSpeedUpdate speedUpdate = new CreatureSpeedUpdate();
        ...
        public static void HandleMovementIndexRunSpeed(Packet packet)
        {
            WowGuid guid = packet.ReadPackedGuid128("MoverGUID");
            packet.ReadInt32("SequenceIndex");
            CreatureSpeedUpdate speedUpdate = new CreatureSpeedUpdate();
        ...
        public static void HandleMovementIndexSwimSpeed(Packet packet)
        {
            WowGuid guid = packet.ReadPackedGuid128("MoverGUID");
            packet.ReadInt32("SequenceIndex");
            CreatureSpeedUpdate speedUpdate = new CreatureSpeedUpdate();
        ...
        public static void HandleMovementIndexFlightSpeed(Packet packet)
        {
            WowGuid guid = packet.ReadPackedGuid128("MoverGUID");
            packet.ReadInt32("SequenceIndex");
            CreatureSpeedUpdate speedUpdate = new CreatureSpeedUpdate();
        ...
        public static void HandleMovementIndexWalkSpeed(Packet packet)
        {
            WowGuid guid = packet.ReadPackedGuid128("MoverGUID");
            packet.ReadInt32("SequenceIndex");
            CreatureSpeedUpdate speedUpdate = new CreatureSpeedUpdate();
        ...
        public static void HandleMovementIndexRunBackSpeed(Packet packet)
        {
            WowGuid guid = packet.ReadPackedGuid128("MoverGUID");
            packet.ReadInt32("SequenceIndex");
            CreatureSpeedUpdate speedUpdate = new CreatureSpeedUpdate();
        ...
        public static void HandleMoveTeleport(Packet packet)
        {
            WowGuid guid = packet.ReadPackedGuid128("MoverGUID");
            packet.ReadInt32("SequenceIndex");
            Vector3 pos = packet.ReadVector3("Position");
            float o = packet.ReadSingle("Facing");

            var bit72 = packet.ReadBit("HasTransport");
            var bit56 = packet.ReadBit("HasVehicleTeleport");

            WowGuid transportGuid = null;
            if (bit72)
                transportGuid = packet.ReadPackedGuid128("TransportGUID");
            ...
            {
                WoWObject mover = Storage.Objects[guid].Item1;
                mover.Movement.Position = pos;
                mover.Movement.Orientation = o;
                mover.Movement.TransportGuid = transportGuid;
            }
        }
