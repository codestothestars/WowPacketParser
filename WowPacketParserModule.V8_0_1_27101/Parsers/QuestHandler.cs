...
namespace WowPacketParserModule.V8_0_1_27101.Parsers
{
    public static class QuestHandler
    {
        ...
        public static void QuestGiverOfferReward(Packet packet)
        {
            ...
            {
                questOfferReward.Emote[i] = (int)packet.ReadInt32("Type");
        ...
        public static void HandleQuestgiverQuestList(Packet packet)
        {
            ...
            uint questsCount = packet.ReadUInt32("QuestsCount");
            packet.ResetBitReader();
            uint greetingLen = packet.ReadBits(12);

            for (int i = 0; i < questsCount; i++)
                V7_0_3_22248.Parsers.NpcHandler.ReadGossipQuestTextData(packet, i, "Quests");
