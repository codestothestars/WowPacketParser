...
namespace WowPacketParserModule.V3_4_0_45166.UpdateFields.V3_4_0_45166
{
    public class UpdateFieldHandler : UpdateFieldsHandlerBase
    {
        ...
        public static IGlyphInfo ReadUpdateGlyphInfo(Packet packet, IGlyphInfo existingData, params object[] indexes)
        {
            var data = existingData as GlyphInfo;
            if (data == null)
                data = new GlyphInfo();
            var rawChangesMask = new int[1];
            rawChangesMask[0] = (int)packet.ReadBits(3);
        ...
        public override IActivePlayerData ReadCreateActivePlayerData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            for (var i = 0; i < 7; ++i)
            {
                data.SpellCritPercentages[i] = packet.ReadSingle("SpellCritPercentage", indexes, i);
